...
<div id="cart_block" class="block exclusive">
	...
	{if $discounts|@count > 0}
		...
		{/if}
		<p id="cart-buttons">
			<a href="//www.prettypegs.com/quick-order" rel="nofollow" id="button_order_cart" class="exclusive_large" title="{l s='Check out' mod='klarnacheckout'}"><span></span>{l s='Check out' mod='klarnacheckout'}</a>
		</p>
